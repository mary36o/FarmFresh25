...
public class ProductModel {
    ...
    // Full constructor
    public ProductModel(String productId, String name, String description, String price,
                        ...
                        boolean inStock, boolean isFeatured, String weight, String unit,
                        ...
                        boolean isGlutenFree,String productCode) {
        this.id = productId;
        this.name = name;
